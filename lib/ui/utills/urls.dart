class Urls {
  ...
  static const String ProgressTaskListUrl = "$_baseUrl/listTaskByStatus/Progress"; // ✅ lowercase
  static const String completeTaskUrl = "$_baseUrl/listTaskByStatus/Complete"; // ✅ lowercase
  static const String cancelledTaskUrl = "$_baseUrl/listTaskByStatus/Cancelled"; // ✅ lowercase
}
